...
namespace CardGames
{
    public class SnapGame
    {
		...
		private static void DrawGame(Snap myGame)
		{
			...
			if (top != null)
			{
				SwinGame.DrawText ("Top Card: " + top.ToString (), Color.White, "GameFont", 20, 3);
				SwinGame.DrawText ("" + myGame.Score(0), Color.White, "GameFont",75, 55);
			...
			{
				SwinGame.DrawText ("No card played yet", Color.White, "GameFont", 20, 3);
			}
